...
const TermsConditions = () => {
  return (
    <div className="terms-container" style={{ padding: "2rem", maxWidth: "900px", margin: "0 auto", lineHeight: "1.6" }}>
      <h1 style={{ textAlign: "center", marginBottom: "1rem" }}>Terms & Conditions – GEM Honda</h1>
      <p><strong>Last Updated:</strong> October 04, 2024</p>

      <section>
        <h2>1. Interpretation and Definitions</h2>
        <h3>Interpretation</h3>
        <p>Words with capitalized initials have defined meanings under the following conditions. These definitions apply whether in singular or plural form.</p>
