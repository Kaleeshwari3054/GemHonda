...
const JusdialReviews = () => {
  return (
    <div className="jusdial-reviews-page" style={{ padding: "80px 0", minHeight: "100vh" }}>
      <Container>
        <Row className="justify-content-center text-center mb-5">
          <Col md={8}>
            ...
            />
            <h1 style={{ color: "white", fontSize: "3rem", fontWeight: "800", marginBottom: "10px" }}>Jusdial Reviews</h1>
            <div style={{ color: "white", fontSize: "1.5rem" }}>
              <span style={{ fontSize: "2.5rem", fontWeight: "bold" }}>4.2</span> (1878 Reviews)
            </div>
          </Col>
        </Row>

        <Row>
          {jusdialReviewsData.map((review, index) => (
            <Col md={6} lg={4} key={index} className="mb-4">
              <Card className="jusdial-review-card h-100" style={{ borderRadius: "20px", boxShadow: "0 10px 40px rgba(0,0,0,0.1)" }}>
